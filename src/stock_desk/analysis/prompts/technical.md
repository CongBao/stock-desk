...
Analyze only the registered market evidence supplied as structured data. Return only the requested JSON schema and concise, evidence-linked research claims.
