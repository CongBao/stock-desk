...
LangString deleteAppData ${LANG_ENGLISH} "Also delete Stock Desk v1.1 user data (v1.0.0 data is not affected)"
LangString stockDeskCleanupUnavailable ${LANG_ENGLISH} "Stock Desk could not prepare its safe data cleanup helper before uninstalling application files. Uninstall will finish and keep all v1.1 data. Stock Desk v1.0.0 data is not affected."
LangString stockDeskCleanupFailed ${LANG_ENGLISH} "Stock Desk v1.1 user data could not be deleted safely. Choose Retry, or Cancel to finish uninstalling and keep all remaining data. Stock Desk v1.0.0 data is not affected."
LangString stockDeskWebView2VerificationFailed ${LANG_ENGLISH} "Stock Desk could not verify a supported production Microsoft Edge WebView2 Runtime (SD-WV2-VERIFY-01). Detected version: $StockDeskWebView2Version. Required version: ${STOCK_DESK_MINIMUM_WEBVIEW2_VERSION} or later. Choose Retry after installing or repairing the official x64 Evergreen Standalone Runtime, or Cancel, restart Windows, and visit https://developer.microsoft.com/microsoft-edge/webview2/ for recovery instructions. Stock Desk has not been installed."
