...
CANONICAL_REQUIREMENTS: dict[str, dict[str, Any]] = {
    ...
    'R-063': _authority('operations', 'operational', 'dedicated_github_ssh_identity', 5, '714debc3a28b3dffc4cde263048baa70781b32d452a9b6b208595c4ce0bc8394', ('delivery-governance', 'github-ssh-and-tag-signing', 'verify-remote-key-and-signed-tag')),
