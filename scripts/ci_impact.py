...
_RELEASE_DESKTOP_FILES = frozenset(
    {
        ...
        "migrations/versions/0012_windows_market_payload.py",
        ...
        "src/stock_desk/storage/models.py",
        "tests/acceptance/test_installed_distribution.py",
        "tests/acceptance/test_upgrade_path.py",
        ...
        "tests/integration/storage/test_migration_locking.py",
        "tests/integration/storage/test_migrations.py",
        "tests/integration/storage/test_package_migrations.py",
        "tests/integration/storage/test_windows_market_payload_migration.py",
