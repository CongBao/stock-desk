...
- v1.1.0 不发布应用内更新元数据，不会在后台下载或执行安装器；升级时请重新访问公开 Release 页面；
...
v1.1.0 does not publish in-app update metadata, download an update in the background, or execute another installer. Visit the public Release page again when upgrading.
